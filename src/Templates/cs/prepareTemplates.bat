...
rmdir ".\Templates\Templates\CSTypeEditor\CustomControlLibrary.Client" /s /q
rmdir ".\Templates\Templates\CSTypeEditor\CustomControlLibrary.Server" /s /q
...
xcopy ".\TemplateSolutions\CustomTypeEditor\CustomControlLibrary.Client\*.*" ".\Templates\Templates\CSTypeEditor\CustomControlLibrary.Client" /s /e /c /f /y /i
xcopy ".\TemplateSolutions\CustomTypeEditor\CustomControlLibrary.Server\*.*" ".\Templates\Templates\CSTypeEditor\CustomControlLibrary.Server" /s /e /c /f /y /i
...
xcopy ".\TemplateSolutions\CustomTypeEditor\CustomTypeEditor.sln" ".\Templates\Templates\CSTypeEditor\" /s /e /c /f /y

...
namespace CustomControlLibrary
{
    ...
    /// custom serializer for this job. Since we cannot refer to the types directly, we need to refer to them 
    /// as full qualified names, and pass them to the <see cref="DesignerSerializerAttribute"/> as strings. 
    /// The custom CodeDom serializer should by default be places in the same assembly as the custom control's designer.
    /// </remarks>
